...
public class AnchorPaneAlunosController implements Initializable {
	...
	public void selectItemTableViewAlunos(Student student) {
		if (student != null) {
			// imprime setando o texto de cada label
	...
	public void handleButtonCadastrar() {
		System.out.println("dhasdhasdjashdkajhdkajshdkajsdhas");
		Student student = new Student();
		showAnchorPaneCadastroAlunosDialog(student);
	}
	
	
	public void showAnchorPaneCadastroAlunosDialog(Student student) {
